// Offline-friendly data mirror of server seed
export const offlineData = {
  models: [
    { id: 'alimak-a1', name: 'Alimak Horizon A1', manufacturer: 'Alimak', site: 'Harbor Tower' },
    { id: 'alimak-a2', name: 'Alimak Skyline A2', manufacturer: 'Alimak', site: 'Skyline Plaza' },
    { id: 'gondola-g1', name: 'GondolaTech G1', manufacturer: 'GondolaTech', site: 'Marina Residences' },
  ],
  subsystems: [
  ...
  symptoms: [
    { id: 'trolley-stopped', subsystemId: 'travel', title: 'Trolley not travelling', description: 'No movement when travel command given' },
    { id: 'hoist-no-lift', subsystemId: 'hoist', title: "Hoist won't raise", description: 'Hoist dead when up command made' },
    { id: 'estop-stuck', subsystemId: 'power', title: 'E-stop not resetting', description: 'E-stop circuit remains latched' },
    { id: 'plc-fault', subsystemId: 'plc', title: 'PLC in fault', description: 'PLC shows fault LED after power cycle' },
  ],
  components: [
    {
      id: 'travel-limit',
  ...
  safetyNotes: [
    { id: 'lock-off', text: 'Isolate and lock-off BMU main power before panel work. Verify absence of voltage.' },
    { id: 'height', text: 'Use fall protection and stay within guardrails when accessing trolley or jib.' },
    { id: 'stored-energy', text: 'Beware of stored energy in hoist brakes and hydraulic accumulators. Release safely.' },
  ],
  faultFlows: [
    {
      id: 'travel-no-move',
      ...
      steps: [
        { id: 's1', title: 'Confirm power and safety chain', detail: 'Reset e-stops, confirm 24V control present, check safety relay LED.', nextOnPass: 's2', nextOnFail: 'saf-lock' },
        { id: 's2', title: 'Inspect travel limit switches', detail: 'Manually actuate forward and reverse limits; check continuity and adjust cams.', nextOnPass: 's3', nextOnFail: 'resolve-limit' },
        { id: 's3', title: 'Check travel contactor and inverter', detail: 'Command travel while probing coil voltage; observe inverter ready/fault status.', nextOnPass: 's4', nextOnFail: 'resolve-contactor' },
        { id: 's4', title: 'Inspect busbar collectors', detail: 'Inspect carbon shoes and springs; clean and ensure full contact.', nextOnPass: null, nextOnFail: 'replace-collector' },
      ],
      resolutions: {
    ...
    },
    {
      ...
      steps: [
        { id: 'hstep1', title: 'Confirm overload and up limit', detail: 'Reset overload relay, ensure no obstruction, confirm up limit not made.', nextOnPass: 'hstep2', nextOnFail: 'hres-limit' },
        { id: 'hstep2', title: 'Check encoder feedback', detail: 'View encoder counts in PLC diagnostics; if static, inspect encoder coupling and cable.', nextOnPass: 'hstep3', nextOnFail: 'hres-encoder' },
        { id: 'hstep3', title: 'Inspect hoist brake', detail: 'Listen for brake lift when command given; measure brake voltage at terminals.', nextOnPass: null, nextOnFail: 'hres-brake' },
      ],
      resolutions: {
    ...
    },
    {
      ...
      steps: [
        { id: 'estep1', title: 'Visual and reset checks', detail: 'Reset all e-stops, inspect mushroom heads, check emergency limits and cable tension switches.', nextOnPass: 'estep2', nextOnFail: 'e-res-reset' },
        { id: 'estep2', title: 'Test loop continuity', detail: 'Isolate control circuit, measure loop continuity end-to-end, wiggle harness to expose breaks.', nextOnPass: 'estep3', nextOnFail: 'e-res-harness' },
        { id: 'estep3', title: 'Check safety relay / PLC input', detail: 'Check relay status, replace if K1/K2 not pulling in; confirm PLC safety bit toggles.', nextOnPass: null, nextOnFail: 'e-res-relay' },
      ],
      resolutions: {
